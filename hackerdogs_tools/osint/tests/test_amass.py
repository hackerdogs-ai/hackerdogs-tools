...
class TestAmassStandalone:
    ...
    def test_amass_standalone(self):
        ...
        result_file = save_test_result("amass", "standalone", result_data, test_domain)
...
class TestAmassLangChain:
    ...
    def test_amass_langchain_agent(self, agent):
        ...
        result = agent.invoke({
            "messages": [HumanMessage(content=f"Find subdomains for {test_domain} using Amass")]
        })
...
class TestAmassCrewAI:
    ...
    def test_amass_crewai_agent(self, agent, llm):
        ...
        task = Task(
            description=f"Find subdomains for {test_domain} using Amass",
            agent=agent,
...
def run_all_tests():
    ...
    try:
        ...
        try:
            ...
            result_file = save_test_result("amass", "langchain", result_data, test_domain)
    ...
    try:
        ...
        try:
            ...
            result_file = save_test_result("amass", "crewai", result_data, test_domain)
