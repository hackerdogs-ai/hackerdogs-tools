...
from hackerdogs_tools.osint.spiderfoot_modules.sfp_virustotal_langchain import sfp_virustotal
from hackerdogs_tools.osint.spiderfoot_modules.sfp_virustotal_crewai import SfpVirustotalTool
