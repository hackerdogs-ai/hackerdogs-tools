...
class TestScrapyStandalone:
    ...
    def test_scrapy_standalone(self):
        ...
        result_file = save_test_result("scrapy", "standalone", result_data, test_domain)
...
class TestScrapyLangChain:
    ...
    def test_scrapy_langchain_agent(self, agent):
        ...
        result = agent.invoke({
            "messages": [HumanMessage(content=f"Find subdomains for {test_domain} using Scrapy")]
        })
...
class TestScrapyCrewAI:
    ...
    def test_scrapy_crewai_agent(self, agent, llm):
        ...
        task = Task(
            description=f"Find subdomains for {test_domain} using Scrapy",
            agent=agent,
...
def run_all_tests():
    ...
    try:
        ...
        try:
            ...
            result_file = save_test_result("scrapy", "langchain", result_data, test_domain)
    ...
    try:
        ...
        try:
            ...
            result_file = save_test_result("scrapy", "crewai", result_data, test_domain)
