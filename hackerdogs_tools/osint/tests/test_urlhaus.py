...
class TestUrlhausStandalone:
    ...
    def test_urlhaus_standalone(self):
        ...
        result_file = save_test_result("urlhaus", "standalone", result_data, test_domain)
...
class TestUrlhausCrewAI:
    ...
    def test_urlhaus_crewai_agent(self, agent, llm):
        ...
        task = Task(
            description=f"Find subdomains for {test_domain} using Urlhaus",
            agent=agent,
