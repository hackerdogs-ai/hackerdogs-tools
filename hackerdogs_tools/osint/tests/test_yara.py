...
class TestYaraStandalone:
    ...
    def test_yara_standalone(self):
        ...
        result_file = save_test_result("yara", "standalone", result_data, test_domain)
...
class TestYaraLangChain:
    ...
    def test_yara_langchain_agent(self, agent):
        ...
        result = agent.invoke({
            "messages": [HumanMessage(content=f"Find subdomains for {test_domain} using Yara")]
        })
        ...
        try:
            ...
            result_file = save_test_result("yara", "langchain", result_data, test_domain)
...
class TestYaraCrewAI:
    ...
    def test_yara_crewai_agent(self, agent, llm):
        ...
        task = Task(
            description=f"Find subdomains for {test_domain} using Yara",
            agent=agent,
        ...
        try:
            ...
            result_file = save_test_result("yara", "crewai", result_data, test_domain)
