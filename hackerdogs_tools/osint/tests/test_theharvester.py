...
class TestTheharvesterStandalone:
    ...
    def test_theharvester_standalone(self):
        ...
        result = theharvester_search.invoke({
            "runtime": runtime,
            "domain": test_domain,
            "recursive": False,
            "silent": True
        ...
        result_file = save_test_result("theharvester", "standalone", result_data, test_domain)
...
class TestTheharvesterLangChain:
    ...
    def test_theharvester_langchain_agent(self, agent):
        ...
        result = agent.invoke({
            "messages": [HumanMessage(content=f"Find subdomains for {test_domain} using Theharvester")]
        })
...
class TestTheharvesterCrewAI:
    ...
    def test_theharvester_crewai_agent(self, agent, llm):
        ...
        task = Task(
            description=f"Find subdomains for {test_domain} using Theharvester",
            agent=agent,
...
def run_all_tests():
    ...
    try:
        ...
        try:
            ...
            result_file = save_test_result("theharvester", "langchain", result_data, test_domain)
    ...
    try:
        ...
        try:
            ...
            result_file = save_test_result("theharvester", "crewai", result_data, test_domain)
