...
class TestExiftoolStandalone:
    ...
    def test_exiftool_standalone(self):
        ...
        result_file = save_test_result("exiftool", "standalone", result_data, test_domain)
...
class TestExiftoolLangChain:
    ...
    def test_exiftool_langchain_agent(self, agent):
        ...
        result = agent.invoke({
            "messages": [HumanMessage(content=f"Find subdomains for {test_domain} using Exiftool")]
        })
        ...
        try:
            ...
            result_file = save_test_result("exiftool", "langchain", result_data, test_domain)
...
class TestExiftoolCrewAI:
    ...
    def test_exiftool_crewai_agent(self, agent, llm):
        ...
        task = Task(
            description=f"Find subdomains for {test_domain} using Exiftool",
            agent=agent,
        ...
        try:
            ...
            result_file = save_test_result("exiftool", "crewai", result_data, test_domain)
