...
class TestSpiderfootStandalone:
    ...
    def test_spiderfoot_standalone(self):
        ...
        result = spiderfoot_search.invoke({
            "runtime": runtime,
            "domain": test_domain,
            "recursive": False,
            "silent": True
        ...
        result_file = save_test_result("spiderfoot", "standalone", result_data, test_domain)
...
class TestSpiderfootLangChain:
    ...
    def test_spiderfoot_langchain_agent(self, agent):
        ...
        result = agent.invoke({
            "messages": [HumanMessage(content=f"Find subdomains for {test_domain} using Spiderfoot")]
        })
...
class TestSpiderfootCrewAI:
    ...
    def test_spiderfoot_crewai_agent(self, agent, llm):
        ...
        task = Task(
            description=f"Find subdomains for {test_domain} using Spiderfoot",
            agent=agent,
