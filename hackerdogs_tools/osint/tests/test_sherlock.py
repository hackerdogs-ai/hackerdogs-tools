...
class TestSherlockStandalone:
    ...
    def test_sherlock_standalone(self):
        ...
        result_file = save_test_result("sherlock", "standalone", result_data, test_domain)
...
class TestSherlockLangChain:
    ...
    def test_sherlock_langchain_agent(self, agent):
        ...
        result = agent.invoke({
            "messages": [HumanMessage(content=f"Find subdomains for {test_domain} using Sherlock")]
        })
...
class TestSherlockCrewAI:
    ...
    def test_sherlock_crewai_agent(self, agent, llm):
        ...
        task = Task(
            description=f"Find subdomains for {test_domain} using Sherlock",
            agent=agent,
...
def run_all_tests():
    ...
    try:
        ...
        try:
            ...
            result_file = save_test_result("sherlock", "langchain", result_data, test_domain)
    ...
    try:
        ...
        try:
            ...
            result_file = save_test_result("sherlock", "crewai", result_data, test_domain)
